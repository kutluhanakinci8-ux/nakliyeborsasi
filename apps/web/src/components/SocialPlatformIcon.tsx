...
export function socialPlatformChipClass(id: SocialPlatformId): string {
  return `social-media-chip social-media-chip--icon-only social-media-chip--${id}`;
}

export function SocialPlatformSvg({ id }: { id: SocialPlatformId }) {
  switch (id) {
    case "instagram":
      return (
...
export function SocialPlatformIconLink({
  id,
  href,
}: {
  id: SocialPlatformId;
