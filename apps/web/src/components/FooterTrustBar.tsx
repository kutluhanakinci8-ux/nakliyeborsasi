...
const STORE_BADGES = {
  appStore: { src: "/footer/app-store.svg", width: 135, height: 40, alt: "Download on the App Store" },
  googlePlay: { src: "/footer/google-play.svg", width: 155, height: 60, alt: "Get it on Google Play" },
} as const;

const PAYMENT_MARKS = [
  { src: "/footer/mastercard.svg", width: 72, height: 32, alt: "Mastercard" },
  { src: "/footer/mastercard-securecode.svg", width: 128, height: 32, alt: "Mastercard SecureCode" },
