...
export function MarketplacePageClient() {
  ...
  return (
    <div className="exchange-page">
      <header className="exchange-hero exchange-hero--marketplace" aria-label="Yük arama">
        <div className="exchange-hero-toolbar">
          <div className="exchange-hero-toolbar-meta">
            ...
            <button
              type="button"
              className="btn-refresh-marketplace"
