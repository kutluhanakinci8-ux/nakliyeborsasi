...
| GET | `/fleet/telematics/carrier/live` | Taşıyıcı canlı harita (şoför pinleri + hareket) |
| GET | `/fleet/telematics/carrier/drivers/:id/route` | Rota, hız örnekleri, fren/hız olayları |
