...
[[ -n "${STRIPE_MAIL_ENTERPRISE_PRICE_ID:-}" ]] && echo "STRIPE_MAIL_ENTERPRISE_PRICE_ID: set" || echo "STRIPE_MAIL_ENTERPRISE_PRICE_ID: optional (Enterprise checkout)"
echo "IYZICO_CORPORATE_PRICE_TRY=${IYZICO_CORPORATE_PRICE_TRY:-490.00}"
echo "IYZICO_ENTERPRISE_PRICE_TRY=${IYZICO_ENTERPRISE_PRICE_TRY:-1490.00}"
